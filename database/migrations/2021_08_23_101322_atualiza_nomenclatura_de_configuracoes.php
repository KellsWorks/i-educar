        ...
        DB::unprepared('
            ...
            SET description = (
                CASE key
                    ...
                    WHEN \'legacy.apis.access_key\' THEN \'Chave de acesso ao SoftagonEducation\'
                    WHEN \'legacy.apis.secret_key\' THEN \'Chave secreta do SoftagonEducation\'
                    ...
                    WHEN \'legacy.app.locale.country\' THEN \'País do cliente (código do SoftagonEducation)\'
