    ...
    public function mostraModalPesquisa($municipio, $linkPesquisa)
    {
        return '<script type="text/javascript" src="scripts/jquery/jquery-1.8.3.min.js"></script>
          ...
          <div id="dialog" title="Pesquisa de satisfa&ccedil;&atilde;o">
            <p>Caro usu&aacute;rio(a), a Secretaria Mun. de Educa&ccedil;&atilde;o e a Portabilis Tecnologia, convidam voc&ecirc; a responder a uma pesquisa de satisfa&ccedil;&atilde;o referente ao projeto de moderniza&ccedil;&atilde;o da gest&atilde;o escolar com o SoftagonEducation em ' . $municipio . '.</p>
            <br/>
